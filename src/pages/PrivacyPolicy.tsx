        ...
        <div className="py-6 pt-8 px-4 md:px-6 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <div data-aos="fade-up" data-aos-delay="400" className="text-sm text-text">
              ...
              <p className="flex gap-2 pl-4 py-1"><RiCheckboxCircleFill className="text-[.6rem] text-text translate-y-1.5 flex-shrink-0" />Marketing and Promotions (with consent): We may send you promotional offers, newsletters, and updates related to Flexipay and Oakyard Properties. You can opt-out of receiving these communications at any time.</p>
            </div>
          </div>
          <div className="space-y-1">
            ...
            <div data-aos="fade-up" data-aos-delay="400" className="text-sm text-text">
              ...
              <p className="flex gap-2 pl-4 py-1"><RiCheckboxCircleFill className="text-[.6rem] text-text translate-y-1.5 flex-shrink-0" />Legal and Regulatory Compliance: We may disclose your information when required by law or to protect the rights, property, and safety of Flexipay, Oakyard Properties Ltd., and its users.</p>
          ...
          <div className="space-y-1">
            ...
            <div data-aos="fade-up" data-aos-delay="400" className="text-sm text-text">
              ...
              <p className="flex gap-2 pl-4 py-1"><RiCheckboxCircleFill className="text-[.6rem] text-text translate-y-1.5 flex-shrink-0" />To exercise any of these rights, please  <Link to={'mailto: admin@oakyardproperties.com'} className="decoration-0 text-primary">contact us</Link>.</p>
            </div>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <div data-aos="fade-up" data-aos-delay="400" className="text-sm text-text">
              <p className="flex gap-2 pl-4 py-1"><RiCheckboxCircleFill className="text-[.6rem] text-text translate-y-1.5 flex-shrink-0" /><Link to={'mailto: admin@oakyardproperties.com'} className="decoration-0 text-primary">Our official mail</Link></p>
              <p className="flex gap-2 pl-4 py-1"><RiCheckboxCircleFill className="text-[.6rem] text-text translate-y-1.5 flex-shrink-0" /><Link to={'tel: +2349088888733'} className="decoration-0 text-primary">Give us a call</Link></p>
              <p className="flex gap-2 pl-4 py-1"><RiCheckboxCircleFill className="text-[.6rem] text-text translate-y-1.5 flex-shrink-0" /><Link to={'https://oakyardproperties.com'} className="decoration-0 text-primary">Visit our Parent Company <LuArrowUpRight className="text-xs inline" /></Link></p>
            </div>
          </div>
        </div>
      </article>
