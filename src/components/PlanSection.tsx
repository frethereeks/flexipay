    ...
    return (
        <section className='bg-backdrop py-20 md:py-32 px-4 relative overflow-hidden'>
            <div className="space-y-2 text-center max-w-2xl mx-auto">
                <h4 data-aos="fade-down" data-aos-delay="300" className="text-dark text-2xl md:text-4xl font-bold">Flexi Payment Plans</h4>
                <p data-aos="fade-up" data-aos-delay="600" className="text-base text-text font-normal sm:px-10 md:px-20 leading-snug">Choose the plan that best fits your financial needs and embark on your guaranteed journey to <strong>land ownership in Kuje</strong> with us</p>
            </div>
            <div className="py-10 md:pt-16 flex flex-col md:flex-row md:items-center gap-4 md:max-w-5xl mx-auto">
                <aside data-aos="fade-right" data-aos-delay="1000" className="flex-1 px-4 md:px-6 py-6 bg-white relative border-2 border-primary hover:border-dark/50 rounded-md shadow-[0px_12px_15px_0px_#8c98a41a] before:absolute before:h-10 before:w-10 before:rounded-full before:top-4 before:left-7 before:bg-primary/50 after:absolute after:h-12 after:w-12 after:rounded-full after:top-4 after:left-10 after:bg-primary/50">
                    ...
                    <Link to={`https://wa.me/2349088888733?text=${encodeURI(`Hi, I want to get started with the Flexipay Standard Plan`)}`} target="_blank" rel="noopener noreferrer" className="flex w-max mx-auto py-2 px-6 md:px-10 bg-primary hover:bg-dark text-white text-sm text-center font-semibold cursor-pointer rounded-sm">Get Started</Link>
                </aside>
                <aside data-aos="zoom-out" data-aos-delay="1300" className="flex-1 px-4 md:px-6 py-10 md:pt-12 bg-white relative border-2 border-dark/60 hover:border-dark/50 rounded-md shadow-[0px_12px_15px_0px_#8c98a41a] before:absolute before:h-10 before:w-10 before:rounded-full before:top-4 before:left-7 before:bg-primary/50 after:absolute after:h-12 after:w-12 after:rounded-full after:top-4 after:left-10 after:bg-primary/50">
                    ...
                    <Link to={`https://wa.me/2349088888733?text=${encodeURI(`Hi, I want to get started with the Flexipay Premium Plan`)}`} target="_blank" rel="noopener noreferrer" className="flex w-max mx-auto py-2 px-6 md:px-10 hover:bg-primary bg-dark text-white text-sm text-center font-semibold cursor-pointer rounded-sm">Get Started</Link>
                </aside>
                <aside data-aos="fade-left" data-aos-delay="1500" className="flex-1 py-10 px-4 md:p-6 bg-white relative border-2 border-primary hover:border-dark/50 rounded-md shadow-[0px_12px_15px_0px_#8c98a41a] before:absolute before:h-10 before:w-10 before:rounded-full before:top-4 before:right-7 before:bg-primary/50 after:absolute after:h-12 after:w-12 after:rounded-full after:top-4 after:right-10 after:bg-primary/50">
                    ...
                    <Link to={`https://wa.me/2349088888733?text=${encodeURI(`Hi, I want to get started with the Flexipay Executive Plan`)}`} target="_blank" rel="noopener noreferrer" className="flex w-max mx-auto py-2 px-6 md:px-10 bg-primary hover:bg-dark text-white text-sm text-center font-semibold cursor-pointer rounded-sm">Get Started</Link>
                </aside>
            </div>
        </section>
    )
