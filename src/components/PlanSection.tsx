    ...
    return (
        <section className='bg-backdrop py-20 md:py-32 px-4 relative overflow-hidden'>
            <div className="space-y-2 text-center max-w-2xl mx-auto">
                ...
                <p data-aos="fade-up" data-aos-delay="600" className="text-base text-text font-normal sm:px-10 md:px-20 leading-snug">Choose the plan that best fits your financial needs and embark on your guaranteed journey to land ownership with us</p>
            </div>
